...
readonly archetype_dir=roaker-starter-component-archetype
...
MVN_WITH_BASIC_OPTIONS archetype:generate \
    -DgroupId="$groupId" \
    -DartifactId="roaker-component-$component_name-starter" \
    -Dversion="$component_version" \
    -Dpackage="io.github.roaker666.$component_name" \
